...
<head>
  ...
  <style type="text/css">
    ...
    .row_desc_new{ width: 43px; display: flex; flex-direction: column; }
    .road_new{ flex: 3;  background: #0c2888; position: relative; }
    ...
    .desc_new::before{ content:attr(row); width: 40px; height: 20px; color: white; position: absolute; left: 10px; bottom: 3px; }
    .rowCar_new{ width: 1px; height: 100%; position: absolute; top: 0; left: -4px; z-index: 999; background: #00ffff; }
    .gou_new{ width: 30px; height: 24px; position: absolute;background: 0 0 / 100% 100% no-repeat url("${ctxStatic}/images/goz3.png");z-index: 1000000000000; }
    ...
    .image_roll_new{
      cursor: pointer; height: 33%; width: 3.5%;
    ...
    /*.image_roll_out_new{ height: 35%; width: 1.34%; position: absolute; bottom: 0; left: 0; }*/
    ...
    <div class="right">
      ...
      <div class="show_body">
        ...
        <div class="row_desc_new">
          <div class="desc_new" v-for="val in showLeft" :row="val.row+'排'"></div>
        </div>
        <div id="carBoxId" class="line_new">
          <div class="rowCar_new" :style=" 'left:' + axisx + '%;' " ></div>
          <div v-if="currentWare=='4'" class="rows_new" v-for="val in showLeft">
            <div v-if="val.row == rowCarInfo._rowId" class="gou_new" :style=" 'left:' + axisx + '%;bottom:' + axisy + '%;' ">
              <div class="gou_info_new">{{rowCarInfo._fenceName||''}}</div>
            </div>
        ...
        <div class="line_new" v-if="currentWare!='4'">
          <div class="rows_new" v-for="val in showRight">
            <img :id="roll.location" @click="onClickRoll($event,roll)"
                 :class="['image_roll_new','image_roll_out_new_3',getRollClass(roll),selRoll.packageNo==roll.data.packageNo ? 'roll_active_new' : '' ]"
                 v-for="roll in val.list"
                 :style=" 'bottom:' + roll.y + '%;left:' + roll.x + '%;' + 'z-index:' + (roll.col+roll.lay) "/>
    ...
    methods:{
      ...
      getInventory(ware,area){
        ...
        $.post("${ctx}/showCenter/showInventoryByQu", { qu:ware }, function(res){
          let list = res || []
          // let list = [{"id":398370,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-8","materialNo":"","location":"B1-3-1-2","rowId":"1","columnId":"1","storeyNo":"2","wregion":"B","warehousePlaceName":"B1-3-1-2","num":1,"numUnit":"01","weight":1.312,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398369,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-7","materialNo":"","location":"B1-2-1-2","rowId":"1","columnId":"1","storeyNo":"2","wregion":"B","warehousePlaceName":"B1-2-1-2","num":1,"numUnit":"01","weight":1.212,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398368,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-6","materialNo":"","location":"B0-4-1-1","rowId":"0","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B0-4-1-1","num":1,"numUnit":"01","weight":0.411,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398367,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-5","materialNo":"","location":"B2-2-1-1","rowId":"2","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B2-2-1-1","num":1,"numUnit":"01","weight":2.211,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398366,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-4","materialNo":"","location":"B2-1-1-1","rowId":"2","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B2-1-1-1","num":1,"numUnit":"01","weight":2.111,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398365,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-3","materialNo":"","location":"B1-1-1-2","rowId":"1","columnId":"1","storeyNo":"2","wregion":"B","warehousePlaceName":"B1-1-1-2","num":1,"numUnit":"01","weight":1.112,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398364,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-2","materialNo":"","location":"B1-3-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-3-1-1","num":1,"numUnit":"01","weight":1.311,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398363,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 2.75*1010*788070 A36 营口","packageNo":"KB2025102001-1","materialNo":"","location":"B1-2-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-2-1-1","num":1,"numUnit":"01","weight":1.211,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398225,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 3*1010*76867 A36 营口","packageNo":"KB2025092801-4","materialNo":"","location":"B1-1-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-1-1-1","num":4,"numUnit":"01","weight":4.4942,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398224,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 3*1010*76867 A36 营口","packageNo":"KB2025092801-3","materialNo":"","location":"B1-1-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-1-1-1","num":3,"numUnit":"01","weight":3.0,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398223,"owner":"浙商中拓集团股份有限公司","materialDesc":"卷板 3*1010*76867 A36 营口","packageNo":"KB2025092801-2","materialNo":"","location":"B1-1-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-1-1-1","num":2,"numUnit":"01","weight":2.9262,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"},{"id":398282,"owner":"物产中大国际贸易集团有限公司","materialDesc":"卷板 3*1010*76867 A36 营口","packageNo":"KB2025092801-1","materialNo":"","location":"B1-1-1-1","rowId":"1","columnId":"1","storeyNo":"1","wregion":"B","warehousePlaceName":"B1-1-1-1","num":1,"numUnit":"01","weight":1.0,"weightUnit":"01","placeTemplateType":"3","sendLockNum":0,"sendLockWeight":0.0,"processLockNum":0,"processLockWeight":0.0,"dynamipledgeLockNum":0,"dynamipledgeLockWeight":0.0,"inventoryLockStatus":"0","lockLockNum":0,"futureType":"0","type":"05"}]
          let maxRow = 0;
          if(self.currentWare!='4'){
            ...
            console.log(self.showLeft,'drx--self.showLeft')
            console.log(self.showRight,'drx--self.showRight')
          }else{
            for(let i=0;i<list.length;i++){
              let vent = self.inToLocation(list[i])
              console.log(vent,'drx---envt')
              if(vent.area==area[0]){
                self.showLeft.push(vent)
                if(vent.row>maxRow){
                  maxRow= vent.row
        ...
        if(material && material.columnId && material.columnId.indexOf('库')==-1){
          ...
          if(this.currentWare==='4'){
            ...
            if(wregion === 'A'||wregion === 'C'||wregion === 'E'){
              if(row === '1'|| row === '2'){
                obj.x = 0.65*(parseInt(obj.lay-1)) + 1.42*(parseInt(obj.bingId-1));
                obj.y = 3.5*(parseFloat(obj.lay)-1) + 7.5*(parseFloat(obj.col)-1);
              }else if(row === '0'||row === '3'||row === '4'){
                obj.y = 7.6*(parseInt(obj.lay-1)) ;
                obj.x = 0.65*(parseFloat(obj.lay)-1) + 0.75*(parseFloat(obj.col)-1) + 5.2*(parseFloat(obj.bingId)-1);
              }
            }else{
              if(row === '1'|| row === '2'){
                obj.x = 0.65*(parseInt(obj.lay-1)) + 1.42*(parseInt(obj.bingId-1));
            ...
            const  wregion = _wregion.match(/[A-Za-z]/g)[0];
            if(wregion === 'A'||wregion === 'B'||wregion === 'C'||wregion === 'D'||wregion === 'E'||wregion === 'F'){
              obj.y = 18*(parseInt(obj.lay-1)) ;
              obj.x = 99 - (1.1*(parseFloat(obj.lay)-1) + 1.6*(parseFloat(obj.col)-1) + 16.5*(parseFloat(obj.bingId)-1));
            }else{
              obj.y = 18*(parseInt(obj.lay-1)) ;
              obj.x = (1.1*(parseFloat(obj.lay)-1) + 1.6*(parseFloat(obj.col)-1) + 16.5*(parseFloat(obj.bingId)-1))
            }
          }
      ...
      getRowCarLoc1(list){
        ...
        let axisy=0 , axisx=0;
        for(let i=0;i<list.length;i++){
          if(self.relationId&&list[i].tagId==self.relationId){
            rowCar = list[i]
            break;
          }
        }
        self.rowCarInfo = rowCar
        if(self.relationId&&rowCar){
          let loc = rowCar.fenceName
          let totalRow = self.showLeft.length
          let row = loc.search(/排/)>-1 ? parseInt(loc.match(/[\d]+(?=排)/)[0]?loc.match(/[\d]+(?=排)/)[0]:0) : 0;

          axisy = parseFloat(((parseFloat(row-1) / totalRow) * 100).toFixed(4))

          if(self.currentTrack=='D'||self.currentTrack=='C'){
            rowCar.axisx = parseFloat(rowCar.axisx) - 169
          }
          if(self.currentTrack=='B'||self.currentTrack=='A'){
            rowCar.axisx = parseFloat(rowCar.axisx) - 314
          }
          axisx = parseFloat(((parseFloat(rowCar.axisx) / 148) * 100).toFixed(3))
          //     if(self.currentTrack=='E'||self.currentTrack=='C'||self.currentTrack=='A'){
          //         rowCar.axisy = parseFloat(rowCar.axisy) - 42
          //     }
          //     axisy = parseFloat(((parseFloat(rowCar.axisy) / 45) * 100).toFixed(3))

          if(self.oldInfo){
            if( self.oldInfo.axisy < self.rowCarInfo.axisy ){
              axisy+=2
            }else{
              axisy-=2
            }
            self.oldInfo = self.rowCarInfo
          }
      ...
      getRowCarLoc(list){
        ...
        const childElement = $('#'+loc).get(0);
        if (childElement) {
          self.rowCarInfo = Object.assign(rowCar,{
            _fenceName:loc,
          })
        }else {
          self.rowCarInfo = Object.assign(rowCar,{
        ...
        if(self.relationId&&rowCar && rowCar.layerName==='室外' && fenceNameReg.test(loc)) {
          const re = /\d+/g;
          const ZMre = /[A-Za-z]/
          ...
          if(wregion === 'A'||wregion === 'C'||wregion === 'E'){
            if(row == '1'|| row == '2'){
              axisx = 0.65*(parseInt(storeyNo-1)) + 1.42*(parseInt(bingId-1));
              axisy = 3.5*(parseFloat(storeyNo)-1) + 7.5*(parseFloat(columnId)-1);
            }else if(row == '0'||row == '3'||row == '4'){
              axisy = 7.6*(parseInt(storeyNo-1)) ;
              axisx = 0.65*(parseFloat(storeyNo)-1) + 0.75*(parseFloat(columnId)-1) + 5.2*(parseFloat(bingId)-1);
            }
          }else{
            if(row == '1'|| row == '2'){
              axisx = 0.65*(parseInt(storeyNo-1)) + 1.42*(parseInt(bingId-1));
